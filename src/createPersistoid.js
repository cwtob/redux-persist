...
export default function createPersistoid(config: PersistConfig): Persistoid {
  ...
  const update = _.throttle(_update, THROTTLE_WAIT_DURATION, {
    leading: false,
    trailing: true,
  })
  ...
  function processNextKey() {
    if (keysToProcess.length === 0) {
      ...
      timeIterator = null
      console.log(
        '%credux-persist/createPersistoid/processNextKey - no more keys',
        'color: #5cc3ad'
      )
      return
    }
    ...
    console.log(
      '%credux-persist/createPersistoid/processNextKey start - ' + key,
      'color: #5cc3ad'
    )
    ...
    console.log(
      '%credux-persist/createPersistoid/processNextKey end - ' + key,
      'color: #5cc3ad'
    )
  }
